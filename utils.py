...
def plot_train_vs_test_loss(epochs, train_loss, test_loss):
  train_range = range(1,epochs+1)
  plt.plot(train_range, train_loss, 'g', label='Training loss')
  plt.plot(train_range, test_loss, 'b', label='validation loss')
